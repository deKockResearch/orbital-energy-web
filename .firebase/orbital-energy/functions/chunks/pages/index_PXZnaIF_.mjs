...
const $$IntroTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Introduction", "id": "intro-tab", "isActive": "true" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2>Lots of words here.</h2> ` })}`;
...
const $$VirialAOsTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Virial Atomic Orbitals", "id": "virialaos-tab" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, {})} ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "virialaos" })}  ${maybeRenderHead()}<div class="tabs-wrapper"> <ul class="nav-tabs"> <li class="tab is-active" data-target="#vaoenergy-tab">VAO Energy</li> <li class="tab" data-target="#ionization-energy-tab">
Ionization Energy
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Orbital Energy", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> <div id="header" data-astro-cid-j7pv25f6> <span class="version" data-astro-cid-j7pv25f6> Version 28 Feb 2024</span> <h1 data-astro-cid-j7pv25f6>The Electronic Structure of Atoms</h1> <h2 data-astro-cid-j7pv25f6>
