import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent, F as Fragment, h as renderHead } from '../astro_ML8uDNy_.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
...
const $$IntroTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$f, $$props, $$slots);
  Astro2.self = $$IntroTab;
  const items = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/intro.md": () => import('./intro_WhoLpb41.mjs')}), () => "../pages/intro.md");
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Introduction", "id": "intro-tab", "isActive": "true" }, { "default": ($$result2) => renderTemplate`${items.map(({ Content }) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Content", Content, {})} ` })}`)}` })}`;
}, "/Users/vtn2/src/orbital-energy-web/src/components/IntroTab.astro", void 0);
...
}, "/Users/vtn2/src/orbital-energy-web/src/components/IonizationEnergy.astro", void 0);
...
const $$VAOEnergyTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Energies", "id": "vaoenergy-tab", "isActive": "true" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div id="matrices" class="horizontal-flex"> ${renderComponent($$result2, "Matrix", $$Matrix, { "id": "dynamic23", "matrix": dynamic23Matrix })} ${renderComponent($$result2, "Matrix", $$Matrix, { "id": "faussurier", "matrix": faussurierMatrix })} ${renderComponent($$result2, "SelectableMatrix", $$SelectableMatrix, {})} </div>  <div id="eLevelsID"></div> <h4>Total:</h4> <div id="totalEnergies" class="horizontal-flex"> <span id="dynamic23TotalEnergy"></span> <span id="faussurierTotalEnergy"></span> <span id="selectableTotalEnergy"></span> </div> <h4>tvTable</h4> <div id="tvTables" class="horizontal-flex"> <table id="dynamic23TvTable"></table> <table id="faussurierTvTable"></table> <table id="selectableTvTable"></table> </div> <h4>vijTable</h4> <div id="vijTables" class="horizontal-flex"> <table id="dynamic23VijTable"></table> <table id="faussurierVijTable"></table> <table id="selectableVijTable"></table> </div> ` })} `;
}, "/Users/vtn2/src/orbital-energy-web/src/components/VAOEnergyTab.astro", void 0);

const $$Astro$7 = createAstro();
const $$VirialAOsTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$7, $$props, $$slots);
  Astro2.self = $$VirialAOsTab;
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Virial Atomic Orbitals", "id": "virialaos-tab" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "virialaos" })} ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, {})}  ${maybeRenderHead()}<div class="tabs-wrapper"> <ul class="nav-tabs"> <li class="tab is-active" data-target="#vaoenergy-tab">VAO Energy</li> <li class="tab" data-target="#ionization-energy-tab">
Ionization Energy
</li> </ul> ${renderComponent($$result2, "VAOEnergyTab", $$VAOEnergyTab, {})} ${renderComponent($$result2, "IonizationEnergy", $$IonizationEnergy, {})} </div> ` })}`;
}, "/Users/vtn2/src/orbital-energy-web/src/components/VirialAOsTab.astro", void 0);

const $$Astro$6 = createAstro();
const $$CAOEnergyTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$CAOEnergyTab;
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Energies", "id": "caoenergy-tab", "isActive": "true" }, { "default": ($$result2) => renderTemplate`
Stuff here.
` })} `;
}, "/Users/vtn2/src/orbital-energy-web/src/components/CAOEnergyTab.astro", void 0);

const $$Astro$5 = createAstro();
const $$Integrals = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$Integrals;
  const items = await Astro2.glob(/* #__PURE__ */ Object.assign({"../scripts/integrals/01.md": () => import('../01_ATusk7UE.mjs'),"../scripts/integrals/02.md": () => import('../02_OQTO7O0m.mjs'),"../scripts/integrals/03.md": () => import('../03_CSzUsPGt.mjs'),"../scripts/integrals/04.md": () => import('../04_oA2Cehyd.mjs'),"../scripts/integrals/05.md": () => import('../05_65EYfvS8.mjs'),"../scripts/integrals/06.md": () => import('../06_VF3mRKT2.mjs'),"../scripts/integrals/07.md": () => import('../07_7fAUQARd.mjs'),"../scripts/integrals/08.md": () => import('../08_ewB999Qi.mjs'),"../scripts/integrals/09.md": () => import('../09_HuPXHTFy.mjs'),"../scripts/integrals/10.md": () => import('../10_6ZAw6Dx2.mjs')}), () => "../scripts/integrals/*.md");
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Integrals", "id": "integrals-tab", "data-astro-cid-to7igkah": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<button id="download-info" data-astro-cid-to7igkah> <a download href="integrals.xlsx" data-astro-cid-to7igkah>Download data for all elements (.xlsx)</a> </button> <div class="integrals-info" data-astro-cid-to7igkah> <!-- There is only one item in the items array. --> ${items.map(({ Content }) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-to7igkah": true }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Content", Content, { "data-astro-cid-to7igkah": true })} ` })}`)} <div id="no-integrals-tables-to-show" data-astro-cid-to7igkah></div> </div> ` })}  `;
}, "/Users/vtn2/src/orbital-energy-web/src/components/Integrals.astro", void 0);

const $$Astro$4 = createAstro();
const $$CanonicalAOsTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$CanonicalAOsTab;
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Canonical Atomic Orbitals", "id": "canonicalaos-tab" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "canonicalaos" })} ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, {})}  ${maybeRenderHead()}<div class="tabs-wrapper"> <ul class="nav-tabs"> <li class="tab is-active" data-target="#caoenergy-tab">CAO Energy</li> <li class="tab" data-target="#ionization-energy-tab">
Ionization Energy
</li> <li class="tab" data-target="#integrals-tab">Integrals</li> </ul> ${renderComponent($$result2, "CAOEnergyTab", $$CAOEnergyTab, {})} ${renderComponent($$result2, "IonizationEnergy", $$IonizationEnergy, {})} ${renderComponent($$result2, "Integrals", $$Integrals, {})} </div> ` })}`;
}, "/Users/vtn2/src/orbital-energy-web/src/components/CanonicalAOsTab.astro", void 0);

const $$Astro$3 = createAstro();
const $$GraphsTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$GraphsTab;
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Graphs", "id": "graphs-tab" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "graphs" })} ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, {})} ${maybeRenderHead()}<div class="charts-area"> <div id="charts-wrapper"> <canvas id="atomicSizeChartCanv"></canvas> <canvas id="electronAffinityChartCanv"></canvas> <canvas id="polarizabilityChartCanv"></canvas> <canvas id="ionizationEnergyChartCanv"></canvas> <canvas id="weightedIonizationEnergyChartCanv"></canvas> </div> <div id="energy-info-for-element"> <div id="energy-element-name"></div> <div id="energy-atomic-size"></div> <div id="energy-electron-affinity"></div> <div id="energy-polarizability"></div> <div id="energy-ionization-energy"></div> </div> </div> ` })} `;
}, "/Users/vtn2/src/orbital-energy-web/src/components/GraphsTab.astro", void 0);

const $$Astro$2 = createAstro();
const $$ReferencesEtcTab = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$ReferencesEtcTab;
  const items = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/references.md": () => import('./references_e6rPh23S.mjs')}), () => "../pages/references.md");
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "References, etc.", "id": "references-tab" }, { "default": ($$result2) => renderTemplate`${items.map(({ Content }) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Content", Content, {})} ` })}`)}` })}`;
}, "/Users/vtn2/src/orbital-energy-web/src/components/ReferencesEtcTab.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Orbital Energy", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> <div id="header" data-astro-cid-j7pv25f6> <span class="version" data-astro-cid-j7pv25f6> Version 2 Mar 2024</span> <h1 data-astro-cid-j7pv25f6>The Electronic Structure of Atoms</h1> <h2 data-astro-cid-j7pv25f6>
Virial Atomic Orbitals, Canonical Atomic Orbitals, Total Energy, and
        much more
</h2> </div> <div class="tabs-wrapper" data-astro-cid-j7pv25f6> <ul class="nav-tabs" data-astro-cid-j7pv25f6> <li class="tab is-active" data-target="#intro-tab" data-astro-cid-j7pv25f6>Intro</li> <li class="tab" data-target="#virialaos-tab" data-astro-cid-j7pv25f6>Virial AOs</li> <li class="tab" data-target="#canonicalaos-tab" data-astro-cid-j7pv25f6>Canonical AOs</li> <li class="tab" data-target="#graphs-tab" data-astro-cid-j7pv25f6>Graphs</li> <li class="tab" data-target="#references-tab" data-astro-cid-j7pv25f6>References and more</li> </ul> ${renderComponent($$result2, "IntroTab", $$IntroTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "VirialAOsTab", $$VirialAOsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CanonicalAOsTab", $$CanonicalAOsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "GraphsTab", $$GraphsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "ReferencesEtcTab", $$ReferencesEtcTab, { "data-astro-cid-j7pv25f6": true })} </div> </main>   ` })}`;
