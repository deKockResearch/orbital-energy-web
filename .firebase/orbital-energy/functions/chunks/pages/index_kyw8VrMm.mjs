...
const $$IntroTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Intro", "id": "intro-tab" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2>Lots of words here.</h2> ` })}`;
...
const $$IonizationEnergy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="ion-energy-area"> <div id="ion-energy-left-table">
Ground state
...
const $$VirialAOsTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Virial AOs", "id": "virialaos-tab", "data-astro-cid-sbh7o24a": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "virialaos", "data-astro-cid-sbh7o24a": true })} ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, { "data-astro-cid-sbh7o24a": true })} ${maybeRenderHead()}<div id="energy-box" data-astro-cid-sbh7o24a> <!-- next element is where canvas gets attached --> <div id="eLevelsID" data-astro-cid-sbh7o24a></div> <h4 data-astro-cid-sbh7o24a>Total:</h4> <div id="totalEnergies" class="horizontal-flex" data-astro-cid-sbh7o24a> <span id="dynamic23TotalEnergy" data-astro-cid-sbh7o24a></span> <span id="faussurierTotalEnergy" data-astro-cid-sbh7o24a></span> <span id="selectableTotalEnergy" data-astro-cid-sbh7o24a></span> </div> <h4 data-astro-cid-sbh7o24a>tvTable</h4> <div id="tvTables" class="horizontal-flex" data-astro-cid-sbh7o24a> <table id="dynamic23TvTable" data-astro-cid-sbh7o24a></table> <table id="faussurierTvTable" data-astro-cid-sbh7o24a></table> <table id="selectableTvTable" data-astro-cid-sbh7o24a></table> </div> <h4 data-astro-cid-sbh7o24a>vijTable</h4> <div id="vijTables" class="horizontal-flex" data-astro-cid-sbh7o24a> <table id="dynamic23VijTable" data-astro-cid-sbh7o24a></table> <table id="faussurierVijTable" data-astro-cid-sbh7o24a></table> <table id="selectableVijTable" data-astro-cid-sbh7o24a></table> </div> </div> <div id="matrices" class="horizontal-flex" data-astro-cid-sbh7o24a> ${renderComponent($$result2, "Matrix", $$Matrix, { "id": "dynamic23", "matrix": dynamic23Matrix, "data-astro-cid-sbh7o24a": true })} ${renderComponent($$result2, "Matrix", $$Matrix, { "id": "faussurier", "matrix": faussurierMatrix, "data-astro-cid-sbh7o24a": true })} ${renderComponent($$result2, "SelectableMatrix", $$SelectableMatrix, { "data-astro-cid-sbh7o24a": true })} </div> ${renderComponent($$result2, "IonizationEnergy", $$IonizationEnergy, { "data-astro-cid-sbh7o24a": true })} ` })}  `;
...
const $$Integrals = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button id="download-info" data-astro-cid-to7igkah> <a download href="integrals.xlsx" data-astro-cid-to7igkah>Download data for all elements (.xlsx)</a> </button> <div data-astro-cid-to7igkah> <!-- There is only one item in the items array. --> ${items.map(({ Content }) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-to7igkah": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, { "data-astro-cid-to7igkah": true })} ` })}`)} <div style="display: none" id="no-integrals-tables-to-show" data-astro-cid-to7igkah>
No Integrals Info available.
</div> </div> <p data-astro-cid-to7igkah></p>  `;
...
const $$CanonicalAOsTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Canonical AOs", "id": "canonicalaos-tab" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ElementsTable", $$ElementsTable, { "id": "canonaicalaos" })} ${renderComponent($$result2, "UnitsSelector", $$UnitsSelector, {})} ${renderComponent($$result2, "Integrals", $$Integrals, {})} ` })}`;
...
const $$ReferencesEtcTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "References, etc.", "id": "references-tab" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h2>References, links, About information, etc</h2> ` })}`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Orbital Energy", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> <div id="header" data-astro-cid-j7pv25f6> <span class="version" data-astro-cid-j7pv25f6> Version 9 Feb 2024</span> <h1 data-astro-cid-j7pv25f6>The Electronic Structure of Atoms Reconsidered</h1> <h1 data-astro-cid-j7pv25f6>Virial AOs, Comm. AOs, T of E., and much more</h1> </div> <div class="tabs-wrapper" data-astro-cid-j7pv25f6> <ul class="nav-tabs" data-astro-cid-j7pv25f6> <li class="tab is-active" data-target="#intro-tab" data-astro-cid-j7pv25f6>Intro</li> <li class="tab" data-target="#virialaos-tab" data-astro-cid-j7pv25f6>Virial AOs</li> <li class="tab" data-target="#canonicalaos-tab" data-astro-cid-j7pv25f6>Canonical AOs</li> <li class="tab" data-target="#graphs-tab" data-astro-cid-j7pv25f6>Graphs</li> <li class="tab" data-target="#references-tab" data-astro-cid-j7pv25f6>References and more</li> </ul> ${renderComponent($$result2, "IntroTab", $$IntroTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "VirialAOsTab", $$VirialAOsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CanonicalAOsTab", $$CanonicalAOsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "GraphsTab", $$GraphsTab, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "ReferencesEtcTab", $$ReferencesEtcTab, { "data-astro-cid-j7pv25f6": true })} </div> <!-- <ElementsTable /> --> </main>  ` })}`;
