...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_BhcDW_EI.mjs';
import 'kleur/colors';
import 'clsx';
...
const _page3  = () => import('./chunks/index_lgR8mW0s.mjs');const pageMap = new Map([["node_modules/astro/dist/assets/endpoint/node.js", _page0],["src/pages/intro.md", _page1],["src/pages/references.md", _page2],["src/pages/index.astro", _page3]]);
