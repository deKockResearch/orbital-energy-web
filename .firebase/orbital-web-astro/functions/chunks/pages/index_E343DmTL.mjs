...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Orbital Energy", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> <span class="version" data-astro-cid-j7pv25f6> Version 31 Jan 2024</span> <h1 data-astro-cid-j7pv25f6>Orbital Energy</h1> ${renderComponent($$result2, "TopTable", $$TopTable, { "data-astro-cid-j7pv25f6": true })} <div id="matrices" class="horizontal-flex" data-astro-cid-j7pv25f6> <!-- <table id="dynamic23Matrix"></table>
